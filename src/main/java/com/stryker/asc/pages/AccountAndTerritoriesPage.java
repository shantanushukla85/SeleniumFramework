...
public class AccountAndTerritoriesPage {
	...
	/**
	 * anshumans UploadFile
	 * 
	 * @param imagePath
	 * @throws AWTException void Jan 4, 2022
	 */
	...
	/**
	 * anshumans verifyElementExistWithDynamicText
	 * 
	 * @param dynamicText
	 * @return boolean Jan 4, 2022
	 */
	...
	/**
	 * anshumans proxyLoginUsingUser
	 * 
	 * @param user
	 * @param role
	 * @throws InterruptedException void Jan 4, 2022
	 */
	...
	public void proxyLoginUsingUser2(String accName) throws InterruptedException {

		if (commonLib.isDisplayed("SF_ASCSales_setUpUserPage_searchAtTop_XPATH")) {
			commonLib.sendkeys_by_JavaScript("SF_ASCSales_setUpUserPage_searchAtTop_XPATH", accName);
	...
	/**
	 * anshumans selectAppFromLeftSideIconWaffle
	 * 
	 * @param appName
	 * @throws InterruptedException void Jan 4, 2022
	 */
	...
	/**
	 * anshumans sfdcLib.clickAppFromHeader
	 * 
	 * @param app void Jan 4, 2022
	 * @throws InterruptedException
	 */
	public boolean clickAppFromHeader(String app) throws InterruptedException {
		boolean flag = false;
		commonLib.refreshPage();
		// String xpath2="//span[@class='slds-var-p-right_x-small' and text()='" + app +
		// "']";
	...
	/**
	 * anshumans verifyAccountExistAfterSearchFromTopSearch
	 * 
	 * @param accName
	 * @return boolean Jan 4, 2022
	 */
	...
	/**
	 * anshumans addTerrMemberInRegion
	 * 
	 * @param userName
	 * @param permission void Jan 4, 2022
	 */
	...
	/**
	 * anshumans searchAccountByNameFromAccountPage
	 * 
	 * @param accNAme
	 * @throws InterruptedException void Jan 4, 2022
	 */
	...
	public void openNewSupportCaseCDGOForm() throws InterruptedException, IOException {
		// commonLib.performHoverByJavascript("SF_ASCSales_account_myAccount_suppCase_menuItems_XPATH");
		commonLib.click("SF_ASCSales_account_myAccount_suppCase_menuItems_XPATH");
		commonLib.clickbyjavascript("SF_ASCSales_account_myAccount_suppCase_newCDGOButton_XPATH");

	}

	public void switchtoFrameSelectRequestType() {
		commonLib.waitforFramenadSwitch("SF_ASCSales_account_myAccount_requestTypeWindow_XPATH");

	}

	public void fillSupportCaseCDGOForm() {
		sfdcLib.click("SF_ASCSales_account_myAccount_suppCase_division_XPATH");
		sfdcLib.clickWithDynamicValue("SF_ASCSales_account_myAccount_suppCase_DynamicSelectCGDOfields_XPATH",
				"Endoscopy");

		sfdcLib.click("SF_ASCSales_account_myAccount_suppCase_requestType_XPATH");
		sfdcLib.clickWithDynamicValue("SF_ASCSales_account_myAccount_suppCase_DynamicSelectCGDOfields_XPATH",
				"New Bill-To and New Ship-To");

		sfdcLib.click("SF_ASCSales_account_myAccount_suppCase_priority_XPATH");
		sfdcLib.clickWithDynamicValue("SF_ASCSales_account_myAccount_suppCase_DynamicSelectCGDOfields_XPATH", "Low");
		commonLib.getScreenshot();
		commonLib.softAssert.assertAll("Form filled with necessary details");

		sfdcLib.click("SF_ASCSales_account_myAccount_suppCase_NextButton_XPATH");

		sfdcLib.click("SF_ASCSales_account_myAccount_suppCase_radioButton_XPATH");
		commonLib.getScreenshot();
		sfdcLib.click("SF_ASCSales_account_myAccount_suppCase_NextButton_XPATH");
	}

	public String getCDGOCaseNumber() {
		commonLib.waitForPresenceOfElementLocated("SF_ASCSales_account_myAccount_suppCase_CDGOCaseNumber_XPATH");
		String CDGONumCreated = commonLib.getText("SF_ASCSales_account_myAccount_suppCase_CDGOCaseNumber_XPATH");
		return CDGONumCreated;
	}

	public void fillLoxRequest() {
		commonLib.clickbyjavascript("SF_ASCSales_account_myAccount_suppCase_division_XPATH");
		commonLib.clickbyjavascriptWithDynamicValue(
				"SF_ASCSales_account_myAccount_suppCase_DynamicSelectCGDOfields_XPATH", "Instruments");

		commonLib.sendKeys("SF_ASCSales_account_myAccount_loxIntegration_addressField_XPATH", "Test");
		commonLib.getScreenshot();
		commonLib.clickbyjavascript("SF_ASCSales_account_myAccount_suppCase_NextButton_XPATH");

		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_loxIntegration_success_XPATH", null),
				" New Lox Created", " Lox case not created");
		commonLib.getScreenshot();
		commonLib.clickbyjavascript("SF_ASCSales_account_myAccount_suppCase_NextButton_XPATH");
	}

	public String getLOXCaseNumber() {
		commonLib.waitForPresenceOfElementLocated("SF_ASCSales_account_myAccount_suppCase_LOXCaseNumber_XPATH");
		String LOXNumCreated = commonLib.getText("SF_ASCSales_account_myAccount_suppCase_LOXCaseNumber_XPATH");
		return LOXNumCreated;
	}
	...
	public boolean addNewASCOwner() {
		...
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner1_XPATH", null),
				" Surgeon exists", " Does not exist");
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner2_XPATH", null),
				" Hospital/IDN exists", " Does not exist");
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner3_XPATH", null),
				" Management Company exists", " Does not exist");
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner4_XPATH", null),
				" Private Equity exists", " Does not exist");
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner5_XPATH", null),
				" Additional Physician exists", " Does not exist");
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner6_XPATH", null),
		...
		sfdcLib.click("SF_ASCSales_account_myAccount_newASCOwner_ascAccount_Input_XPATH");
		...
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_saveError_XPATH", null),
				" Expected error exists", " Does not exist");
	...
	public void verifyAccountTeamMember() {
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_AccountTeamMember_XPATH", null),
				" Team Member exists", " Does not exist");
		sfdcLib.click("SF_ASCSales_account_myAccount_AccountTeamMember_XPATH");

		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_AccountTeamMember_rights_XPATH", null),
				" User has Read/Write rights", " Does not have Read/Write rights");
		sfdcLib.click("SF_ASCSales_account_myAccount_accName_XPATH");
	}
	...
	public String createNewEnterpriseAccByAdmin() {
		...
		int enterpriseID = commonLib.randomInteger(2, 100);
		...
		commonLib.sendKeys("SF_ASCSales_newAccount_postalCode_XPATH", "38601");
	...
	public String createNewEnterpriseAccByASCSalesRep() {
		...
		commonLib.scroll_view("SF_ASCSales_entPriseAccForm_countryListBox_XPATH");
		sfdcLib.click("SF_ASCSales_entPriseAccForm_countryListBox_XPATH");
		sfdcLib.clickWithDynamicValue("SF_ASCSales_general_spanWithTitle_XPATH", "United States");

		commonLib.scroll_view("SF_ASCSales_newAccount_shippingpostalCode_XPATH");
		commonLib.sendKeys("SF_ASCSales_newAccount_shippingpostalCode_XPATH", "38601");
	...
	public boolean openRegionAndRelatdTab(String rgnNAme) throws InterruptedException {
		...
		flag = verifyElementExistWithSoftAssert("SF_ASCSales_Region_presenceof_zipcode_XPATH", "Zip Code Section");
		return flag;
	}
	...
	public boolean createNewActivityForOppAndVerify() {
		...
		flag = verifyElementExist("SF_ASCSales_toastMessageForSuccess_XPATH", "new activity created");
		if (flag) {
	...
	public boolean verifyElementExistWithSoftAssert(String element, String elementName) {
		...
		commonLib.softAssertThat(exist, "Field/Element " + elementName + "exists",
	...
	public void clickOptionsTabForPartcularAccOrOpp(String tabName) {
		...
		commonLib.clickbyjavascriptWithDynamicValue("SF_ASCSales_sfdcLib.click_optionsTabForPartcularAccOrOpp_XPATH",
				tabName);
		commonLib.getScreenshot();
	...
	public void verifyPricingAndFinanceUserInAccountTeam() {
		...
		boolean member = commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Scott Naquin");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Tracey Vance - Sales Rep");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Nick Jones - Sales RM");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Katelyn Chase - Sales RM");
		commonLib.getScreenshot();
		commonLib.softAssertThat(member, "All the members exist", "Members do not exist");
		/*
	...
	public void verifyRegionDetailPage() {
		...
		verifyElementExistWithSoftAssert("SF_ASCSales_Region_presenceof_zipcode_XPATH", "Zip Code Section");
	}

	public void verifyActiveTerrMemberForRegion() throws InterruptedException, IOException {
		// commonLib.performHoverByJavascript("SF_ASCSales_Region_TerrMemAssig_viewAll_XPATH");

		commonLib.clickbyjavascript("SF_ASCSales_Region_TerrMemAssig_viewAll_XPATH");
		// commonLib.clickby("SF_ASCSales_Region_TerrMemAssig_viewAll_XPATH");
		verifyElementExistWithSoftAssert("SF_ASCSales_Region_TerrMemAssig_viewAll_XPATH",
				"TerrMemberAssignment Data Table");
		verifyElementExistWithSoftAssert("SF_ASCSales_Region_TerrMemAssig_ActiveMember_XPATH", "Active member");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_RegionTerritoryMembersPage_DynamicName_XPATH",
				"Scott Naquin");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_RegionTerritoryMembersPage_DynamicName_XPATH",
				"Tracey Vance - Sales Rep");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_RegionTerritoryMembersPage_DynamicName_XPATH",
	...
	public void verifyAccountTeamMemberswithRegions() {
		boolean member = commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Scott Naquin");
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Tracey Vance - Sales Rep");
		...
		commonLib.verifyPresence_Dynamic_Xpath("SF_ASCSales_AccTeamMembersPage_DynamicName_XPATH",
				"Katelyn Chase - Sales RM");
		commonLib.getScreenshot();
		commonLib.softAssertThat(member, "All the active territory members exist in the Account Team Tab",
	...
	public void verifyManagementTypeAccForAScOwnerAndAccount() throws InterruptedException {
		...
		sfdcLib.click("SF_ASCSales_account_myAccount_ascOwner_newButton_XPATH");
		commonLib.softAssertThat(
				verifyElementExistByWait("SF_ASCSales_account_myAccount_newASCOwner_typeOfOwner_XPATH", null), " exist",
				" not exist");
		Thread.sleep(5000);
	...
	public void verifyRelatedListForAccount() throws InterruptedException {
		...
		verifyElementExistWithSoftAssert("SF_ASCSales_account_contact_XPATH", " contact related list");

		commonLib.scroll_view("SF_ASCSales_account_ManagementCompany_XPATH");
		verifyElementExistWithSoftAssert("SF_ASCSales_account_ManagementCompany_XPATH",
	...
	public void accountDetailsPageVerification() {
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_buildCheckBox_XPATH", null),
				" New Build Checkbox exists", " Does not exist");
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_billingAddressHeader_XPATH", null),
				" Billing Address Field exists", " Does not exist");
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_shippingAddressHeader_XPATH", null),
				" Shipping Address Field exists", " Does not exist");
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_divisionalContact_Tab_XPATH", null),
				" Divisional Contacts tab exists", " Does not exist");
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_divisionalAccounts_Tab_XPATH", null),
				" Divisional Accounts tab exists", " Does not exist");
	}

	public void accountRelatedListVerification() {
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_RelatedList_opportunities_XPATH", null),
				" Opportunities exists in related list", " Does not exist");
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_ManagementCompany_XPATH", null),
				" ASC Management Company exists in related list", " Does not exist");
		commonLib.softAssertThat(verifyElementExistByWait("SF_ASCSales_account_AddressInfo_XPATH", null),
				" Address Info exists in related list", " Does not exist");
	}
